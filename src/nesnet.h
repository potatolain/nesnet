 ...
 * Generally it's a good idea to run this continously after startup, or after some input, like hitting start. This can and
 * should be run once per frame until it reports success.
